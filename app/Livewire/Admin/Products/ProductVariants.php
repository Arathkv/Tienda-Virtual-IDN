...
class ProductVariants extends Component
{
    ...
    public function deleteFeature($opion_id, $feature_id)
    {
        $this->product->options()->updateExistingPivot($opion_id,[
            'features' => array_filter($this->product->options->find($opion_id)->pivot->features, function ($feature) use ($feature_id) {
