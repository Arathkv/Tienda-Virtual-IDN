    ...
    <div class="card">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="col-span-1">
                ...
                <p class="fint-semibold text-2xl text-gray-600 mb-4">
                    MX/ {{$product->price}}
                </p>
                                    ...
                                    <li>
                                        ...
                                        @switch($option->type)
                                            @case(1)
                                                ...
                                                <button class="w-20 h-8 font-semibold uppercase text-sm rounded-lg {{$selectedFeatures[$option->id] == $feature['id'] ? 'bg-purple-600 text-white' : 'border border-gray-200 text-gray-700' }} "
                                            ...
                                            @case(2)
                                                <div class="p-0.5 border-2 rounded-lg flex items-center -mt-1.5 {{$selectedFeatures[$option->id] == $feature['id'] ? 'border-purple-600' : 'border-transparent'}} ">
                                                    <button class="w-20 h-8 rounded-lg border border-gray-200" wire:click="$set('selectedFeatures.{{$option->id}}', '{{$feature['id']}}')" style="background-color: {{$feature['value']}}">
                ...
                <div class="text-gray-700 flex items-center space-x-4">
                    <i class="fa-solid fa-truck-fast text-2x1">
                        Envio a domicilio
                    </i>
                </div>
