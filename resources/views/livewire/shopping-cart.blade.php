    ...
    <div class="grid grid-cols-1 lg:grid-cols-7 gap-6">
        <div class="lg:col-span-5">
            ...
            <div class="flex justify-between mb-2">
                ...
                <button class="font-semibold text-gray-600 hover:text-pruple-400 underline hover:no-underline"
                    wire:click="destroy()">
                    Limpiar Carro
                </button>
            ...
            <div class="card">
                ...
                <div class="flex justify-between font-semibold mb-2">
                   ...
                   {{-- <a href="{{route('shipping.index')}}" class="btn btn-purple block w-full text-center">
                    ...
                    <a href="#" class="btn btn-purple block w-full text-center" wire:click="redirectToShipping">
                        Continuar compra
                    </a>
